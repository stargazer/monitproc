...
def addsitepackages(known_paths):
    ...
    setuptools_path = '/mnt/hgfs/smartpr/webserver-monitor/eggs/setuptools-0.6c12dev_r88846-py2.6.egg'
    sys.path.append(setuptools_path)
    known_paths.add(os.path.normcase(setuptools_path))
    import pkg_resources
    buildout_paths = [
        '/mnt/hgfs/smartpr/webserver-monitor/eggs/setuptools-0.6c12dev_r88846-py2.6.egg',
        '/mnt/hgfs/smartpr/webserver-monitor/eggs/zc.buildout-1.5.2-py2.6.egg'
        ]
    ...
    original_paths = [
        ...
        '/usr/local/lib/python2.6/dist-packages/PIL-1.1.7-py2.6-linux-x86_64.egg',
        '/usr/local/lib/python2.6/dist-packages/django_debug_toolbar-0.8.5-py2.6.egg',
        '/usr/local/lib/python2.6/dist-packages/docutils-0.7-py2.6.egg',
        '/usr/local/lib/python2.6/dist-packages/Jinja2-2.5.5-py2.6.egg',
        '/usr/local/lib/python2.6/dist-packages/Pygments-1.4-py2.6.egg',
        '/usr/local/lib/python2.6/dist-packages/psutil-0.3.0-py2.6-linux-x86_64.egg',
